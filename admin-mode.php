...
<div style="margin-top: 55px; margin-left: -125px">
  <div class="admin-box">
    ...
    <button class="slide" style="margin: 0"><a href="news.php" style="text-decoration:none">NEWS</a></button>
    <button class="slide" style="margin: 0"><a href="kontakti.php" style="text-decoration:none">MESSAGES</a></button>
